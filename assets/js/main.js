...
const I18N = {
  en: {
    ...
    savePlan: 'Save plan',
    heroTitle: '<span class="hero-line">Plan <span>smarter.</span></span><span class="hero-line">Pay off your mortgage sooner.</span>',
  ...
  fa: {
    ...
    savePlan: 'ذخیره پلان',
    heroTitle: '<span class="hero-line">هوشمندانه <span>پلان کنید.</span></span><span class="hero-line">وام خانه‌تان را زودتر پرداخت کنید.</span>',
  ...
  hi: {
    ...
    heroTitle: '<span class="hero-line">बेहतर <span>योजना बनाएं.</span></span><span class="hero-line">अपना मॉर्गेज जल्दी चुकाएं.</span>',
  ...
  ur: {
    ...
    heroTitle: '<span class="hero-line">بہتر <span>منصوبہ بنائیں.</span></span><span class="hero-line">اپنا مورگیج جلدی ادا کریں.</span>',
  ...
  zh: {
    ...
    brand: '房贷规划器',
    savePlan: '保存计划',
    heroTitle: '<span class="hero-line">更聪明地<span>规划。</span></span><span class="hero-line">更快还清房贷。</span>',
  ...
  es: {
    ...
    heroTitle: '<span class="hero-line">Planifica <span>mejor.</span></span><span class="hero-line">Paga tu hipoteca antes.</span>',
