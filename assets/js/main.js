...
const I18N = {
  ...
  hz: {
    docTitle: 'پلان‌گر قرض خانه',
    brand: 'پلان‌گر قرض خانه',
    savePlan: 'پلان ره ذخیره کو',
    heroTitle: 'هوشیارانه <span>پلان کو.</span><br>قرض خانه ره زودتر خلاص کو.',
    heroLead: 'ببین پرداخت اضافه و راه‌های هوشیارانه چطو می‌تانه وقت و هزارها دالر سود ره برت کم کنه.',
    benefit1: 'مصرف سود<br>کمتر',
    benefit2: 'قرض خانه ره<br>زودتر خلاص کو',
    benefit3: 'آزادی مالی<br>بساز',
    statLoan: 'باقیمانده فعلی قرض',
    statRate: 'نرخ سود',
    statTerm: 'مدت پرداخت',
    statFrequency: 'تکرار پرداخت',
    statPayment: 'پرداخت',
    calcTitle: 'حساب‌گر قرض خانه',
    calcSub: 'معلومات قرض خوره داخل کو تا وقت خلاص‌شدن قرض حساب شوه.',
    loanStartDate: 'تاریخ شروع قرض',
    dateHint: 'روز / ماه / سال',
    currentLoanBalance: 'باقیمانده فعلی قرض',
    interestRate: 'نرخ سود',
    amortizationPeriod: 'مدت پرداخت',
    repaymentFrequency: 'تکرار پرداخت',
    strategiesTitle: 'گزینه‌های راه',
    strategiesSub: 'یک یا چند گزینه ره انتخاب کو تا راه‌ها مقایسه شوه.',
    offsetTitle: 'حساب آفست ره زیاد کو',
    offsetDesc: 'سود قرض ره کم می‌کنه.',
    use: 'استفاده',
    currentOffset: 'مبلغ فعلی آفست / برداشت دوباره',
    growOffsetBy: 'آفست ره زیاد کو به مقدار',
    growFrequency: 'تکرار زیادشدن',
    extraTitle: 'پرداخت اضافه',
    extraDesc: 'هر وخت خواستی اضافه پرداخت کو.',
    extraAmount: 'مبلغ اضافه',
    howOften: 'چند وقت یک‌بار',
    lumpTitle: 'پرداخت یک‌باره',
    lumpDesc: 'یک پرداخت برای کم‌کدن قرض.',
    lumpAmount: 'مبلغ پرداخت یک‌باره',
    interestComparison: 'مقایسه سود',
    interestComparisonSub: 'هر راه ره جدا ببین، بعد نتیجه یکجای گزینه‌های انتخاب‌شده ره مقایسه کو.',
    clearComparison: 'مقایسه روشن پهلو به پهلو',
    noStrategyBaseline: 'حالت عادی بی راه',
    baselineDesc: 'ای مقدار سودی اس که اگر بی آفست، بی پرداخت اضافه و بی پرداخت یک‌باره پیش بری، پرداخت می‌کنی.',
    offsetOnly: 'فقط حساب آفست',
    offsetOnlyDesc: 'بر بنیاد مبلغ آفست و زیادشدن آفست.',
    extraOnly: 'فقط پرداخت اضافه',
    extraOnlyDesc: 'بر بنیاد مبلغ پرداخت اضافه و تکرار او.',
    lumpOnly: 'فقط پرداخت یک‌باره',
    lumpOnlyDesc: 'بر بنیاد یک پرداخت یک‌باره که فعلاً انجام می‌ته.',
    interestPay: 'سودی که پرداخت می‌کنی',
    interestSave: 'سودی که صرفه می‌کنی',
    offsetCardP: 'نشان می‌ته پول در آفست چقدر سود قرض ره کم می‌کنه.',
    extraCardP: 'نشان می‌ته پرداخت اضافه بالای پرداخت عادی چقدر سود ره کم می‌کنه.',
    lumpCardP: 'نشان می‌ته یک پرداخت یک‌باره چقدر سود ره کم می‌کنه. اگر مبلغ $0 باشه، صرفه هم $0 می‌شه.',
    liveCombined: 'نتیجه یکجای زنده',
    interestPayShort: 'سودی که پرداخت می‌کنی',
    payoffTime: 'وقت خلاص‌شدن قرض',
    newPayoffDate: 'تاریخ نو خلاص‌شدن',
    chartTitle: 'باقیمانده قرض در گذر وقت',
    legendNoStrategy: 'بی راه',
    legendOffsetOnly: 'فقط آفست',
    legendAllSelected: 'همه راه‌های انتخاب‌شده',
    payoffNoStrategy: 'وقت خلاص‌شدن قرض (بی راه)',
    payoffOffsetOnly: 'وقت خلاص‌شدن قرض (فقط آفست)',
    payoffAllSelected: 'وقت خلاص‌شدن قرض (گزینه‌های انتخاب‌شده)',
    timeSaved: 'وقت صرفه‌شده',
    footerLine: 'امروز پلان کو. فردا آسوده باش.',
    product: 'محصول',
    calculator: 'حساب‌گر',
    savedPlans: 'پلان‌های ذخیره‌شده',
    resources: 'منابع',
    ...
    yearly: 'سالانه',
    years: 'سال',
    noStrategySelected: 'هیچ راهی انتخاب نشده',
    noStrategySelectedDesc: 'یک یا چند گزینه راه ره روشن کو تا نتیجه یکجای ره ببینی.',
    allSelectedStrategies: 'همه راه‌های انتخاب‌شده',
    allSelectedStrategiesDesc: 'ای نتیجه حساب آفست، پرداخت اضافه و پرداخت یک‌باره ره یکجا حساب می‌کنه.',
    selectedComboDesc: 'ای نتیجه گزینه‌های راهی ره که در حساب‌گر روشن کدی، یکجا حساب می‌کنه.',
    offset: 'آفست',
    extraRepayment: 'پرداخت اضافه',
    oneOffLumpSum: 'پرداخت یک‌باره',
    paidOffMonthsSooner: (n) => `${n} ماه زودتر خلاص می‌شه`,
    monthSingular: 'ماه',
    monthPlural: 'ماه',
    yearSingular: 'سال',
    yearPlural: 'سال',
    monthlyBreakdownTitle: 'جزئیات پرداخت ماهانه',
    monthlyBreakdownSub: 'بر بنیاد گزینه‌های راهی که فعلاً انتخاب شده.',
    monthlyBreakdownBadge: 'بعد از راه انتخاب‌شده',
    monthlyRepaymentAfter: 'پرداخت',
    monthlyRepaymentHint: '',
    monthlyInterestPart: 'سهم سود ای ماه',
    monthlyInterestHint: 'بعد از حساب‌کدن آفست و پرداخت یک‌باره.',
    monthlyPrincipalPart: 'سهم اصل قرض ای ماه',
    monthlyPrincipalHint: 'ای بخش باقیمانده قرض ره کم می‌کنه.',
    monthlyInterestSaved: 'سود صرفه‌شده ای ماه',
    monthlySavedHint: 'در مقایسه با حالت بی راه.',
    datePlaceholder: 'روز / ماه / سال',
    amountPlaceholder: 'مبلغ ره داخل کو',
    ratePlaceholder: 'نرخ ره داخل کو'
  },
...
function localeCode() {
  const map = { en:'en-AU', fa:'fa-AF', hz:'fa-AF', hi:'hi-IN', ur:'ur-PK', zh:'zh-CN', es:'es-ES' };
